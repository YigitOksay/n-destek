...
export default function PrimarySearchAppBar() {
  ...
  const handleSupportRequest = () => {
    // Destek talebi oluştur butonuna tıklandığında gerçekleşecek işlemler
    // Örneğin: Destek formunu açmak veya destek sayfasına yönlendirmek
    console.log('Destek talebi oluşturuldu');
    // Burada istediğiniz işlemleri gerçekleştirebilirsiniz
  };
  const ProfileInfo = () => {
    // Profil fotoğrafı ve isim burada alınabilir
    const profileName = "John Doe"; // Örnek bir isim
  ...
  >
    Destek Talebi Oluştur
          ...
          <Box sx={{ flexGrow: 1 }} />
          <Box sx={{ display: { xs: "none", md: "flex" } }} className="icon">
            <IconButton
              className="mailIcon"
              size="large"
            ...
            >
              <ProfileInfo /> {/* Profil fotoğrafı ve ismin olduğu bileşen */}
            </IconButton>
          </Box>
